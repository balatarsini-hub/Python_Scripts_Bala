...
|---|---|---|
| `Topline Generate Data` | To clean the Raw file| Topline Nielsen File|
| `MY CPD and LDB` | To genereate Topline Report for MY| Clean_Merged file|
| `SG CPD and LDB` | To genereate Topline Report for SG| Clean_Merged file|
