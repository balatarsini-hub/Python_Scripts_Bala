...
MKT = r"C:\Users\balatarsini_avinitya\Downloads\Mkt est 2026_Jun.xlsx"  # Market-by-Channel summary source

current_month = "Jun"          # anchor month to operate on
...
lux = Path(r"C:\Users\balatarsini_avinitya\Downloads\New LUX report summary_SG_May'26(Others market remain as Others).xlsx")     # LUX market report

# Update BR Data Split here (post-channel-mapped, optionally split)
br = Path(r"C:\Users\balatarsini_avinitya\Downloads\Final folders\LLD Market Estimation  V10.6.2026\LLD Market numbers\Actual Market\SG\BR After Split SG May'26 - Include All Platform.xlsx")
